...
- 日本語コーパスは **リポジトリ内の静的データ** (`src/data/jaCorpus/`)。現在は **72 分野 / 7 グループ / 2,760 文** (本人の文 1,315 + 追加案 1,445)。日本語・英語とも重複ゼロです。
...
- **RealFi**: 分野 67〜72 が RealFi グループ (週一回のコールで実際に使う言い方、120 文)。
