...
- 日本語コーパスは **リポジトリ内の静的データ** (`src/data/jaCorpus/`)。66 分野 × 平均 40 文 = 約 2,640 文が目標で、現在は全 66 分野 2,640 文 (本人の文 1,315 + 追加案 1,325) が入っています。
...
- **分野の街** (`/city`): 66 分野が 66 の街区になっていて、思い出せる文が増えると建物が育ち、灯りがつきます。街区をタップすると、**その分野で覚えた文が吹き出しで出ます** (🔀 で別の文へ)。
