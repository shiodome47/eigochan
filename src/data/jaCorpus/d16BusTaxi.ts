...
export const D16_SELF: JaSentenceInput[] = [
  ...
  { ja: "思っていたより本数が少ないですね。", en: "There are fewer buses than I expected.", ch: ["There are fewer buses", "than I expected"], scene: "バス", to: "家族", imp: "must" },
  ...
  { ja: "駅までお願いします。", en: "To the station, please.", scene: "タクシー", to: "運転手", imp: "must" },
...
export const D16_ADD: JaSentenceInput[] = [
  ...
  { ja: "平日と休日で時間が違うようです。", en: "The times seem to differ on weekdays and weekends.", ch: ["The times seem to differ", "on weekdays and weekends."], scene: "バス", to: "家族", imp: "sub" },
  ...
  { ja: "おつりは大丈夫です。", en: "Keep the change.", scene: "タクシー", to: "運転手", imp: "often" },
  { ja: "荷物を出してもらえますか。", en: "Could you get my bag out?", ch: ["Could you get", "my bag out?"], scene: "タクシー", to: "運転手", imp: "often" },
  { ja: "気をつけて運転してください。", en: "Drive safely.", scene: "タクシー", to: "運転手", imp: "sub" },
];
