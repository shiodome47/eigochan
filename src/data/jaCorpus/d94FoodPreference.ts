...
export const D94_ADD: JaSentenceInput[] = [
  ...
  { ja: "慣れると平気になります。", en: "You get used to it.", scene: "会話", to: "相手", imp: "must" },
