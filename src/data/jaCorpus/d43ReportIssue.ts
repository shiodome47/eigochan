...
export const D43_SELF: JaSentenceInput[] = [
  ...
  { ja: "今日確認したところ、同じ操作ができなくなっていました。", en: "When I checked today, the same operation no longer worked.", ch: ["When I checked today", ", the same operation no longer worked."], scene: "仕事", to: "同僚", imp: "must" },
  { ja: "具体的には、この画面で処理が止まります。", en: "Specifically, the process stops on this screen.", ch: ["Specifically", ", the process stops on this screen."], scene: "仕事", to: "同僚", imp: "must" },
  ...
  { ja: "ほかの人にも同じ問題が起きているか確認したいです。", en: "I'd like to check whether others are seeing the same problem.", ch: ["I'd like to check whether", "others are seeing the same problem."], scene: "仕事", to: "同僚", imp: "must" },
  ...
  { ja: "再現手順もまとめておきます。", en: "I'll also write up the steps to reproduce it.", ch: ["I'll also write up", "the steps to reproduce it."], scene: "仕事", to: "同僚", imp: "must" },
  ...
  { ja: "現時点では、一部の機能だけに影響しているようです。", en: "At this point, it seems to affect only some of the functions.", scene: "仕事", to: "同僚", imp: "must" },
