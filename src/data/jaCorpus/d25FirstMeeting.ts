...
export const D25_SELF: JaSentenceInput[] = [
  { ja: "はじめまして。山田と申します。", en: "Nice to meet you. My name is Yamada.", ch: ["Nice to meet you.", "My name is Yamada."], scene: "イベント", to: "初対面", imp: "must" },
  ...
  { ja: "説明すると少し長くなるんですが、ブロックチェーンに関係する仕事です。", en: "It takes a while to explain, but it's work related to blockchain.", ch: ["It takes a while to explain,", "but it's work related to blockchain"], scene: "イベント", to: "初対面", imp: "must" },
  ...
  { ja: "まだ十分に理解できていないので、もう少し教えてもらえますか。", en: "I don't fully understand it yet, so could you tell me a bit more?", ch: ["I don't fully understand it yet", ", so could you tell me a bit more?"], scene: "イベント", to: "初対面", imp: "must" },
...
export const D25_ADD: JaSentenceInput[] = [
  ...
  { ja: "私はまだ勉強中です。", en: "I'm still learning.", scene: "イベント", to: "初対面", imp: "must" },
