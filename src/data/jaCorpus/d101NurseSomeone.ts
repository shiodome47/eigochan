...
export const D101_ADD: JaSentenceInput[] = [
  ...
  { ja: "顔色がよくないです。", en: "You look pale.", scene: "家", to: "家族", imp: "must" },
  { ja: "横になっていてください。", en: "Just lie down.", scene: "家", to: "家族", imp: "must" },
  ...
  { ja: "水分をこまめに取ってください。", en: "Keep sipping water.", scene: "家", to: "家族", imp: "must" },
  { ja: "のどは渇いていませんか。", en: "Are you thirsty?", scene: "家", to: "家族", imp: "must" },
