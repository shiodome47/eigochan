...
export const D102_ADD: JaSentenceInput[] = [
  ...
  { ja: "あわてないでください。", en: "Don't panic.", scene: "外出", to: "家族", imp: "must" },
  { ja: "きっと出てきます。", en: "It'll turn up.", scene: "外出", to: "家族", imp: "must" },
  { ja: "上着のポケットは見ましたか。", en: "Did you check your coat pocket?", ch: ["Did you check", "your coat pocket?"], scene: "外出", to: "家族", imp: "must" },
  { ja: "ありました。", en: "Found it.", scene: "外出", to: "家族", imp: "must" },
  ...
  { ja: "鳴らしてみます。", en: "I'll call it.", scene: "家", to: "家族", imp: "must" },
