...
export const D26_SELF: JaSentenceInput[] = [
  ...
  { ja: "気がついたら、もうこんな時期ですね。", en: "Before I knew it, it's already this time of year.", ch: ["Before I knew it,", "it's already this time of year"], scene: "会話", to: "友人", imp: "must" },
...
export const D26_ADD: JaSentenceInput[] = [
  ...
  { ja: "それは面白そうですね。", en: "That sounds interesting.", scene: "会話", to: "友人", imp: "must" },
  ...
  { ja: "そういえば、あの人は元気ですか。", en: "By the way, how is that person doing?", ch: ["By the way,", "how is that person doing?"], scene: "会話", to: "友人", imp: "often" },
  ...
  { ja: "何かあれば言ってください。", en: "Just tell me if you need anything.", scene: "会話", to: "友人", imp: "must" },
  { ja: "気をつけて帰ってくださいね。", en: "Get home safely.", scene: "会話", to: "友人", imp: "must" },
];
