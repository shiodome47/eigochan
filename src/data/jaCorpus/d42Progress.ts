...
export const D42_SELF: JaSentenceInput[] = [
  ...
  { ja: "一度は動いたのですが、その後また同じ問題が出ました。", en: "It worked once, but then the same problem came back.", ch: ["It worked once", ", but then the same problem came back."], scene: "会議", to: "同僚", imp: "must" },
...
export const D42_ADD: JaSentenceInput[] = [
  ...
  { ja: "テストはこれから行います。", en: "Testing comes next.", scene: "会議", to: "同僚", imp: "must" },
