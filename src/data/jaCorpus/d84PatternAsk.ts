...
export const D84_ADD: JaSentenceInput[] = [
  ...
  { ja: "この辺で写真を撮るなら、どこが一番いいですか。", en: "Where is the best place to take photos around here?", ch: ["Where is the best place", "to take photos?"], scene: "外出", to: "相手", imp: "must", pat: "Where is the best place to ~?" },
