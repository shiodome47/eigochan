...
export const D85_ADD: JaSentenceInput[] = [
  ...
  { ja: "そのまま続けてください。", en: "Keep going.", ch: ["Keep", "going"], scene: "会話", to: "相手", imp: "must", pat: "Keep [verb-ing]" },
  { ja: "そのまま話してください。", en: "Keep talking.", ch: ["Keep", "talking"], scene: "会話", to: "相手", imp: "often", pat: "Keep [verb-ing]" },
  { ja: "急がないでください。", en: "Please don't rush.", ch: ["Please don't", "rush"], scene: "会話", to: "相手", imp: "must", pat: "Please do not ~" },
  ...
  { ja: "文句を言うのはやめましょう。", en: "Let's stop complaining.", ch: ["Let's stop", "complaining"], scene: "会話", to: "家族", imp: "often", pat: "Stop [verb-ing]" },
];
