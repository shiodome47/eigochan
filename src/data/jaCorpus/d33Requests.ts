...
export const D33_SELF: JaSentenceInput[] = [
  ...
  { ja: "もう少し分かりやすく説明してもらえると助かります。", en: "It would help if you could explain it a little more clearly.", ch: ["It would help if you could", "explain it more clearly"], scene: "会話", to: "相手", imp: "must" },
  ...
  { ja: "念のため、もう一度確認してもらえますか。", en: "Just to be safe, could you check it once more?", ch: ["Just to be safe,", "could you check once more?"], scene: "会話", to: "相手", imp: "must" },
  ...
  { ja: "急ぎではないので、無理のないときで大丈夫です。", en: "It's not urgent, so whenever it's convenient is fine.", ch: ["It's not urgent,", "whenever is convenient"], scene: "会話", to: "相手", imp: "must" },
