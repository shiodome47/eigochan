...
export const D105_ADD: JaSentenceInput[] = [
  ...
  { ja: "清潔さは大事です。", en: "Cleanliness matters.", ch: ["Cleanliness", "matters"], scene: "会話", to: "家族", imp: "must" },
  ...
  { ja: "取り消しはできますか。", en: "Can we cancel?", ch: ["Can we", "cancel?"], scene: "会話", to: "家族", imp: "must" },
  ...
  { ja: "税金は含まれていますか。", en: "Is tax included?", ch: ["Is tax", "included?"], scene: "会話", to: "家族", imp: "must" },
  { ja: "合計でいくらになりますか。", en: "What's the total?", ch: ["What's", "the total?"], scene: "会話", to: "家族", imp: "must" },
  ...
  { ja: "予約が取れました。", en: "We're booked.", ch: ["We're", "booked"], scene: "会話", to: "家族", imp: "must" },
