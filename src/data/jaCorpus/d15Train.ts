...
export const D15_SELF: JaSentenceInput[] = [
  ...
  { ja: "私は立っていても大丈夫ですよ。", en: "I'm fine standing.", scene: "電車", to: "家族", imp: "must" },
  ...
  { ja: "だんだん混んできましたね。", en: "It's getting crowded.", scene: "電車", to: "家族", imp: "must" },
  { ja: "次の駅でたくさん乗ってきそうです。", en: "A lot of people will probably get on at the next station.", ch: ["A lot of people", "will probably get on at the next station."], scene: "電車", to: "家族", imp: "must" },
...
export const D15_ADD: JaSentenceInput[] = [
  ...
  { ja: "あと二駅ですね。", en: "Two more stops.", scene: "電車", to: "家族", imp: "often" },
