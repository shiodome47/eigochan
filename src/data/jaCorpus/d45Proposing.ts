...
export const D45_SELF: JaSentenceInput[] = [
  ...
  { ja: "操作の数を減らせると、かなり使いやすくなると思います。", en: "If we cut down the number of steps, it would be much easier to use.", ch: ["If we cut down the number of steps,", "it would be much easier to use."], scene: "会議", to: "同僚", imp: "must" },
  ...
  { ja: "よくある質問をまとめておくと役に立ちそうです。", en: "Putting together an FAQ would probably help.", ch: ["Putting together an FAQ", "would probably help."], scene: "会議", to: "同僚", imp: "must" },
  ...
  { ja: "すべてを最初から完成させる必要はないと思います。", en: "I don't think everything has to be finished from the start.", ch: ["I don't think everything has to be", "finished from the start."], scene: "会議", to: "同僚", imp: "must" },
