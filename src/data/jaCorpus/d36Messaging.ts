...
export const D36_SELF: JaSentenceInput[] = [
  ...
  { ja: "電話だとうまく説明できないので、メッセージで送ります。", en: "It's hard to explain over the phone, so I'll send it in a message.", ch: ["It's hard to explain by phone,", "so I'll send a message"], scene: "電話", to: "相手", imp: "must" },
  ...
  { ja: "リンクはこちらです。", en: "Here's the link.", ch: ["Here's", "the link"], scene: "メッセージ", to: "相手", imp: "must" },
