...
export const D18_SELF: JaSentenceInput[] = [
  ...
  { ja: "これには何が入っていますか。", en: "What's in this?", ch: ["What's in", "this?"], scene: "店", to: "店員", imp: "must" },
...
export const D18_ADD: JaSentenceInput[] = [
  ...
  { ja: "禁煙席でお願いします。", en: "Non-smoking, please.", ch: ["Non-smoking,", "please"], scene: "店", to: "店員", imp: "often" },
  ...
  { ja: "デザートはどうしますか。", en: "What about dessert?", ch: ["What about", "dessert?"], scene: "店", to: "家族", imp: "often" },
  { ja: "お腹いっぱいになりました。", en: "I'm completely full.", ch: ["I'm completely", "full"], scene: "店", to: "家族", imp: "must" },
