...
export const D87_ADD: JaSentenceInput[] = [
  ...
  { ja: "今日はしっかり楽しんでください。", en: "Have fun today.", ch: ["Have fun", "today"], scene: "家", to: "家族", imp: "must", pat: "have fun" },
  ...
  { ja: "言いたいことは分かりました。", en: "I get the point.", ch: ["I get", "the point"], scene: "仕事", to: "相手", imp: "must", pat: "get the point" },
  ...
  { ja: "メモを取っておきます。", en: "I'll take notes.", ch: ["I'll take", "notes"], scene: "コール", to: "参加者", imp: "must", pat: "take notes" },
  { ja: "交代でやりましょう。", en: "Let's take turns.", ch: ["Let's take", "turns"], scene: "家", to: "家族", imp: "must", pat: "take turns" },
  ...
  { ja: "無理せず、ゆっくりいきましょう。", en: "Let's take it easy.", ch: ["Let's take", "it easy"], scene: "会話", to: "相手", imp: "must", pat: "take it easy" },
