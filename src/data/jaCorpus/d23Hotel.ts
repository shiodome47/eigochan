...
export const D23_SELF: JaSentenceInput[] = [
  ...
  { ja: "名前は山田です。", en: "The name is Yamada.", scene: "ホテル", to: "フロント", imp: "must" },
  ...
  { ja: "朝食は付いていますか。", en: "Is breakfast included?", scene: "ホテル", to: "フロント", imp: "must" },
  ...
  { ja: "部屋が少し寒いんですが、温度を調整できますか。", en: "The room is a little cold. Can the temperature be adjusted?", ch: ["The room is a little cold", ". Can the temperature be adjusted?"], scene: "ホテル", to: "フロント", imp: "must" },
...
export const D23_ADD: JaSentenceInput[] = [
  ...
  { ja: "駐車場は無料ですか。", en: "Is parking free?", scene: "ホテル", to: "フロント", imp: "often" },
