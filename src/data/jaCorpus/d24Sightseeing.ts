...
export const D24_SELF: JaSentenceInput[] = [
  ...
  { ja: "思っていたより静かな場所ですね。", en: "It's a quieter place than I expected.", ch: ["quieter than", "I expected"], scene: "観光地", to: "家族", imp: "must" },
  ...
  { ja: "全部見るのは少し難しそうですね。", en: "Seeing everything looks a bit difficult.", ch: ["Seeing everything", "looks difficult"], scene: "観光地", to: "家族", imp: "must" },
  ...
  { ja: "少し離れた方が全体が入りそうです。", en: "If you step back a bit, you'll get the whole thing in.", ch: ["If you step back a bit,", "you'll get it all in"], scene: "観光地", to: "通行人", imp: "must" },
