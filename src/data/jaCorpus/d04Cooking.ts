...
export const D04_SELF: JaSentenceInput[] = [
  ...
  { ja: "熱いので気をつけてください。", en: "Careful, it's hot.", scene: "食卓", to: "家族", imp: "must" },
...
export const D04_ADD: JaSentenceInput[] = [
  ...
  { ja: "包丁はどこにありますか。", en: "Where's the knife?", scene: "台所", to: "家族", imp: "often" },
  ...
  { ja: "箸はそこにありますよ。", en: "The chopsticks are right there.", scene: "食卓", to: "家族", imp: "sub" },
  ...
  { ja: "洗い物は私がやりますよ。", en: "I'll do the dishes.", scene: "台所", to: "家族", imp: "must" },
  ...
  { ja: "ゴミはこちらにまとめておきます。", en: "I'll put the trash together over here.", ch: ["I'll put the trash together", "over here"], scene: "台所", to: "家族", imp: "sub" },
