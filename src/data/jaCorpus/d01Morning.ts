...
export const D01_ADD: JaSentenceInput[] = [
  ...
  { ja: "今日はゴミを出す日でしたね。", en: "Today's the day we put the trash out, isn't it?", ch: ["Today's the day we", "..., isn't it?"], scene: "家", to: "家族", imp: "often" },
  { ja: "ゴミをまとめておきました。", en: "I've got the trash ready to go.", ch: ["I've got ...", "ready to go"], scene: "家", to: "家族", imp: "often" },
  ...
  { ja: "靴はどれを履いていきますか。", en: "Which shoes are you going to wear?", ch: ["Which ...", "are you going to wear?"], scene: "玄関", to: "家族", imp: "sub" },
