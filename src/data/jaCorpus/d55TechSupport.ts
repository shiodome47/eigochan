...
export const D55_SELF: JaSentenceInput[] = [
  ...
  { ja: "昨日までは、正常に動いていました。", en: "Everything was fine until yesterday.", scene: "相談", to: "SPO仲間", imp: "must" },
  ...
  { ja: "データベースを削除する前に、ほかに試せることはありますか。", en: "Before I delete the database, is there anything else I can try?", ch: ["Before I delete the database", ", is there anything else I can try?"], scene: "相談", to: "SPO仲間", imp: "must" },
  ...
  { ja: "このコマンドの結果は、正常に見えますか。", en: "Does the output of this command look normal to you?", ch: ["Does the output of this command", "look normal to you?"], scene: "相談", to: "SPO仲間", imp: "must" },
  ...
  { ja: "ただ、なぜ処理が進まないのかが分かりません。", en: "I just don't understand why it isn't making progress.", ch: ["I just don't understand why", "it isn't making progress."], scene: "相談", to: "SPO仲間", imp: "must" },
...
export const D55_ADD: JaSentenceInput[] = [
  ...
  { ja: "原因はこちらの設定ミスでした。", en: "The cause was a mistake in my own settings.", ch: ["The cause was", "a mistake in my own settings."], scene: "相談", to: "SPO仲間", imp: "must" },
