...
export const D104_ADD: JaSentenceInput[] = [
  ...
  { ja: "体に気をつけてください。", en: "Look after yourself.", ch: ["Look after", "yourself"], scene: "外出", to: "家族", imp: "must" },
  ...
  { ja: "道中、気をつけてください。", en: "Safe travels.", ch: ["Safe", "travels"], scene: "外出", to: "家族", imp: "must" },
  ...
  { ja: "分かりました、振ります。", en: "Sure, I will.", ch: ["Sure,", "I will"], scene: "外出", to: "家族", imp: "must" },
  ...
  { ja: "一度確認しておいてください。", en: "Just double-check.", ch: ["Just", "double-check"], scene: "外出", to: "家族", imp: "must" },
  ...
  { ja: "写真を送ってください。", en: "Send me photos.", ch: ["Send me", "photos"], scene: "外出", to: "家族", imp: "must" },
  ...
  { ja: "あなたも元気で。", en: "You too.", ch: ["You", "too"], scene: "外出", to: "家族", imp: "must" },
  { ja: "泣かないでください。", en: "Don't cry.", ch: ["Don't", "cry"], scene: "外出", to: "家族", imp: "must" },
  { ja: "泣いていません。", en: "I'm not crying.", ch: ["I'm not", "crying"], scene: "外出", to: "家族", imp: "must" },
  ...
  { ja: "待っています。", en: "I'll be waiting.", ch: ["I'll be", "waiting"], scene: "外出", to: "家族", imp: "must" },
];
