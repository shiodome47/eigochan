...
export const D31_SELF: JaSentenceInput[] = [
  ...
  { ja: "少し早めに集まった方がよさそうですね。", en: "It'd probably be better to meet a bit earlier.", ch: ["It'd probably be better to", "meet a bit earlier."], scene: "会話", to: "友人", imp: "must" },
  ...
  { ja: "無理に今日中に決めなくてもいいと思います。", en: "I don't think we have to force a decision today.", ch: ["I don't think we have to", "force a decision today."], scene: "会話", to: "同僚", imp: "must" },
  { ja: "もう少し情報が集まってから判断しませんか。", en: "Shall we decide once we have a bit more information?", ch: ["Shall we decide once", "we have a bit more information?"], scene: "会話", to: "同僚", imp: "must" },
  ...
  { ja: "では、それでいきましょう。", en: "Okay, let's do that then.", scene: "会話", to: "同僚", imp: "must" },
];
...
export const D31_ADD: JaSentenceInput[] = [
  ...
  { ja: "オンラインでも大丈夫です。", en: "Online works too.", scene: "会議", to: "同僚", imp: "must" },
