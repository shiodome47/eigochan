...
export const D81_ADD: JaSentenceInput[] = [
  ...
  { ja: "今ちょうど支払いを済ませたところです。", en: "I've just paid.", scene: "買い物", to: "店員", imp: "must", pat: "I have just ~" },
  { ja: "今ちょうど注文したところです。", en: "I've just ordered.", scene: "レストラン", to: "店員", imp: "must", pat: "I have just ~" },
  ...
  { ja: "忘れるかもしれません。", en: "I may forget.", scene: "会話", to: "相手", imp: "must", pat: "I may ~" },
