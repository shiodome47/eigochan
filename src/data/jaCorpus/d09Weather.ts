...
export const D09_SELF: JaSentenceInput[] = [
  ...
  { ja: "この天気なら、洗濯物は外に干せそうですね。", en: "With this weather, we should be able to hang the laundry outside.", ch: ["With this weather,", "we should be able to hang the laundry outside"], scene: "家", to: "家族", imp: "must" },
...
export const D09_ADD: JaSentenceInput[] = [
  ...
  { ja: "今日は冷房を早めに入れましょう。", en: "Let's turn the air conditioning on early today.", ch: ["Let's turn the air conditioning on", "early today"], scene: "家", to: "家族", imp: "often" },
  ...
  { ja: "こんな日は家にいるのが一番ですね。", en: "On a day like this, staying home is the best option.", ch: ["On a day like this", ", staying home is the best option."], scene: "家", to: "家族", imp: "often" },
];
