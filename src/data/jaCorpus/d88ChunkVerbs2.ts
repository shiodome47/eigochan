...
export const D88_ADD: JaSentenceInput[] = [
  ...
  { ja: "できるかぎりやってみます。", en: "I'll do my best.", ch: ["I'll do", "my best"], scene: "仕事", to: "相手", imp: "must", pat: "do your best" },
  ...
  { ja: "また連絡を取り合いましょう。", en: "Let's keep in touch.", ch: ["Let's keep", "in touch"], scene: "会話", to: "友人", imp: "must", pat: "keep in touch" },
  ...
  { ja: "予約を取っておきます。", en: "I'll make a reservation.", ch: ["I'll make", "a reservation"], scene: "レストラン", to: "家族", imp: "must", pat: "make a reservation" },
  ...
  { ja: "そろそろ準備しましょう。", en: "Let's get ready.", ch: ["Let's", "get ready"], scene: "家", to: "家族", imp: "must", pat: "get ready" },
  { ja: "彼はまだ来ていません。", en: "He hasn't shown up yet.", ch: ["He hasn't shown up", "yet"], scene: "外出", to: "相手", imp: "must", pat: "show up" },
  { ja: "誰も来ませんでした。", en: "Nobody showed up.", ch: ["Nobody", "showed up"], scene: "会話", to: "相手", imp: "often", pat: "show up" },
