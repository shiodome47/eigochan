...
export const D91_ADD: JaSentenceInput[] = [
  ...
  { ja: "さっきから何回も切れます。", en: "It keeps disconnecting.", ch: ["It keeps", "disconnecting"], scene: "家", to: "家族", imp: "must" },
  ...
  { ja: "直りました。", en: "That fixed it.", ch: ["That", "fixed it"], scene: "家", to: "家族", imp: "must" },
  ...
  { ja: "一度つなぎ直してみます。", en: "Let me reconnect.", ch: ["Let me", "reconnect"], scene: "家", to: "家族", imp: "must" },
  ...
  { ja: "一度、入り直します。", en: "I'll rejoin.", ch: ["I'll", "rejoin"], scene: "家", to: "家族", imp: "must" },
