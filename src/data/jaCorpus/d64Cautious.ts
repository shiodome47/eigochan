...
export const D64_SELF: JaSentenceInput[] = [
  ...
  { ja: "ただし、実際の運用を見るまでは判断できません。", en: "That said, I can't judge until I see it in actual operation.", scene: "議論", to: "相手", imp: "must" },
  { ja: "技術的には面白いですが、投資としてどうかは別だと思います。", en: "It's interesting technically, but whether it's a good investment is another matter.", scene: "議論", to: "相手", imp: "must" },
  { ja: "将来性はあると思いますが、期待しすぎない方がいいでしょう。", en: "I think it has potential, but it's better not to expect too much.", scene: "議論", to: "相手", imp: "must" },
  ...
  { ja: "今すぐ結論を出す必要はないと思います。", en: "I don't think we need to reach a conclusion right away.", ch: ["I don't think we need to", "reach a conclusion right away."], scene: "議論", to: "相手", imp: "must" },
