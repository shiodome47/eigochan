...
export const D14_SELF: JaSentenceInput[] = [
  ...
  { ja: "快速はこのホームから出ますか。", en: "Does the rapid train leave from this platform?", ch: ["Does the rapid train leave", "from this platform?"], scene: "駅", to: "駅員", imp: "must" },
  ...
  { ja: "乗り換えを考えると、前の方が便利そうです。", en: "Thinking about the transfer, the front looks more convenient.", ch: ["Thinking about the transfer", ", the front looks more convenient."], scene: "駅", to: "家族", imp: "must" },
